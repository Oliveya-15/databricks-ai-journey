...
# DBTITLE 1,TASK 1: Create customer interaction function (exercise)
spark.sql(f"""
...
# DBTITLE 1,Test customer interaction function (exercise)
# MAGIC %sql
...
# DBTITLE 1,TASK 2: Create vector search function (exercise)
spark.sql(f"""
...
# DBTITLE 1,Test product docs search (exercise)
# MAGIC %sql
