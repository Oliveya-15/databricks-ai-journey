...
# MAGIC USE SCHEMA get_started_de;
# MAGIC
# MAGIC -- Compare row counts and values between manual and job Gold tables
# MAGIC SELECT 'Manual Gold' AS source, Country, TotalEmployees FROM country_count_gold
# MAGIC UNION ALL
# MAGIC SELECT 'Job Gold',Role as Country, TotalEmployees FROM total_roles_gold;
...
# MAGIC DESCRIBE HISTORY current_employees_bronze_job;
